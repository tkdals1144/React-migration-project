...
-------------------------------------
## 2025-12-24
- 크롤링 오류 분석 -> 기존 사이트 form 구조 변경 확인
- 크롤링 데이터 수집을 위해서 Service 이외의 전체적인 구조를 고쳐야함을 확인
- DTO, Controller, DB 등을 건들이지 않기 위한 빈 값 주입 대책 마련
- 대상 사이트의 크롤링 방지를 위한 보안강도 증강을 확인
